...
konflux-update-pipelines:
	...
	tkn bundle list quay.io/konflux-ci/tekton-catalog/pipeline-java-builder:devel -o=yaml > pkg/konfluxgen/kustomize/java-builder.yaml
	...
	kustomize build pkg/konfluxgen/kustomize/kustomize-java-builder/ --output pkg/konfluxgen/java-builder.yaml --load-restrictor LoadRestrictionsNone
